  ...
  return (
    <Container className="flex flex-wrap mb-20 lg:gap-10 lg:flex-nowrap ">
      <div className={`flex items-center justify-center w-full lg:w-1/2 ${props.imgPos === "right" ? "lg:order-1" : ""}`}>
        <div>
          <Image src={data.image} width={521} height={521} alt="Benefits" className="object-cover" />
        </div>
      </div>
...
function Benefit(props: { title: string; icon: React.ReactNode; children: React.ReactNode }) {
  return (
